...
return [
    ...
    'documentations' => [
        'default' => [
            'api' => [
                'title' => 'Article API by EKenekiso L. Ugbanawaji',
            ],
    ...
    'defaults' => [
        ...
        'paths' => [
            ...
            */
            'base' => env('L5_SWAGGER_BASE_PATH', 'http://article.test'),
        ...
        */
         ...
         */
        'constants' => [
            'L5_SWAGGER_CONST_HOST' => env('L5_SWAGGER_CONST_HOST', 'http://article.test'),
        ],
    ],
];
